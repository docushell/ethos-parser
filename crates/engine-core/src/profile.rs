    ...
    fn the_default_profile_is_pinned() {
        ...
        assert_eq!(
             ...
             *verbatim, identically* while holding FOURTEEN of SEVENTEEN — missing exactly the \
             ...
             of cloning; `engine extract` on `nist-sp-800-53Ar5` fell from 100.4 s to 59.9 s. \
             ...
             therefore REFUSED — `engine extract` exited 2 and produced nothing — and real files \
