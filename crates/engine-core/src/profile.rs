...
pub struct Profile {
    ...
    ///
    /// See [`crate::markdown::MARKDOWN_RULE_BLOCKS_V2`]. On the profile because it decides what
...
mod tests {
    ...
    fn the_default_profile_is_pinned() {
        ...
        assert_eq!(
            ...
            "sha256:8d46576383768f4b9fa2499a13c1f64dae506382e64bed00eb18330fff41f0ee"
        );
    }
