...
//! `fo:page-width` and `fo:page-height` beside them. A [`engine_core::PageRecord`] could be minted
...
//! `[]`, [`engine_core::OdpLocator`] carries a position named for the element, and
...
use engine_core::{EngineError, OdfBlockKind};
...
enum Structure {
    ...
    ///
    /// **Not a [`engine_core::PageRecord`].** See the module header: this is the element that
