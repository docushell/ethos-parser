...
fn square(
    ...
    let q = f64::from(engine_core::QUANTUM_PER_POINT);
    ...
    d.set(
        "Contents",
        lopdf::Object::string_literal(format!("ethos-engine: {} {}", mark.label, id.as_str())),
    );
...
fn stamp_identity(
    ...
    catalog.set("EthosEngineOverlay", lopdf::Object::Dictionary(id));
}
