...
//!
//! [`engine_core::READING_ORDER_RULE_V1`] is this module. The id is on the profile and on every
...
/// [`engine_core::READING_ORDER_RULE_V1`] and that one is part of
/// [`engine_core::TABLE_DETECTION_UNRULED_V1`]. Sharing the binding would mean a change made for
