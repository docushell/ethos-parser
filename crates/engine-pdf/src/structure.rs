...
use engine_core::{EngineError, PdfTaggedLocator};
use lopdf::{Dictionary, Object, ObjectId};

// The rule id lives in `engine_core::STRUCT_TREE_RULE_V1` and is NOT restated here, for the same
...
impl TaggedTable {
    ...
    pub fn check_against(
        ...
        detected: &[engine_core::TableCellPosition],
    ) -> engine_core::TaggedGridCheck {
        use engine_core::{CellSlot, TaggedGridFault, TaggedGridStatus};
        ...
        engine_core::TaggedGridCheck {
            check_id: engine_core::TAGGED_GRID_CHECK_V1.to_string(),
