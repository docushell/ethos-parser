...
//! author *put text*. They are pinned under different ids — `ruled-rects-v1` and
...
///
/// Part of [`engine_core::TABLE_DETECTION_UNRULED_V1`]: changing it is a rule-version event and
...
/// two columns.
///
/// Part of [`engine_core::TABLE_DETECTION_UNRULED_V1`].
...
mod tests {
    use super::*;
    use engine_core::{CheckStatus, Profile, QUANTUM_PER_POINT};
    ...
    fn the_regular_grid_is_a_three_by_two_table() {
        ...
        assert_eq!(t.rule, engine_core::TABLE_DETECTION_UNRULED_V1);
