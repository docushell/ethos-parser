...
/// The repair's identity, as it appears in [`engine_core::Profile::xref_repair`].
///
...
#[cfg(test)]
fn _refusal_error(r: Refusal) -> engine_core::EngineError {
    engine_core::EngineError::Malformed {
        what: "pdf xref".into(),
