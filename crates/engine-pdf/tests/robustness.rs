...
const EXPECTED_SURVIVORS: [&str; 53] = [
...
fn every_fixture_is_mutated_and_the_coverage_is_reported() {
    ...
    assert_eq!(
        fixtures.len(),
        48,
        "the manifest should declare 48 fixtures across three roots (23 at M7, plus v0.1's \
         ...
         and v1-S7b's background-panel-not-a-grid)"
    );
