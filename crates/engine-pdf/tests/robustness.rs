...
const EXPECTED_SURVIVORS: [&str; 52] = [
...
fn every_fixture_is_mutated_and_the_coverage_is_reported() {
    ...
    assert_eq!(
        fixtures.len(),
        47,
        "the manifest should declare 47 fixtures across three roots (23 at M7, plus v0.1's \
         ...
         invisible-render-mode, off-page-and-offset-box crop-box-smaller-than-media, v1-S6.1's simple-font-two-byte-tounicode, and v1-S6.2's whitespace-past-the-page-edge)"
    );
