...
//! `ethos-parser extract` reads an ODT, and every path that would have needed a page refuses (v2-S5).
//!
...
//! `ethos.parser.odt.v0` and no `ethos-parser extract-odt`; dispatch is by content; and `node_get`
