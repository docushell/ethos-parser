...
//! `ethos-parser extract` reads an XLSX, and every path that would have needed a page refuses (v2-S3).
//!
...
//! `ethos.parser.xlsx.v0` and no `ethos-parser extract-xlsx`; dispatch is by content; and `node_get`
