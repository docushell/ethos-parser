...
///
/// Because the artifact does. [`crate::HTML_RULE_BLOCKS_V8`] settled this repository's answer when
...
///
/// [`crate::HTML_RULE_BLOCKS_V8`] is separate from the Markdown rule because those two can move
...
pub struct Profile {
    ...
    ///
    /// See [`crate::markdown::MARKDOWN_RULE_BLOCKS_V8`]. On the profile because it decides what
    ...
    ///
    /// See [`crate::html::HTML_RULE_BLOCKS_V8`]. A **separate** id from
