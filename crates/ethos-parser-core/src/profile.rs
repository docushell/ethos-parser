...
///
/// Because the artifact does. [`crate::HTML_RULE_BLOCKS_V9`] settled this repository's answer when
...
///
/// [`crate::HTML_RULE_BLOCKS_V9`] is separate from the Markdown rule because those two can move
...
pub struct Profile {
    ...
    ///
    /// See [`crate::markdown::MARKDOWN_RULE_BLOCKS_V9`]. On the profile because it decides what
    ...
    ///
    /// See [`crate::html::HTML_RULE_BLOCKS_V9`]. A **separate** id from
...
impl Default for Profile {
    fn default() -> Self {
        Self {
            ...
            markdown_rule: crate::markdown::MARKDOWN_RULE_BLOCKS_V9.to_string(),
            locate_rule: crate::locate::LOCATE_RULE_V1.to_string(),
            html_rule: crate::html::HTML_RULE_BLOCKS_V9.to_string(),
