...
`crates/ethos-parser-grounding/tests/schema_subset.rs` compares the snapshot against
...
**It is not what the checker validates against.** `ethos-parser-grounding`'s `check` module mirrors
