...
//! [`ethos_parser_core::CellTextSource`] says which, so `SUM(B2:B2)` can never be mistaken for a number
//! the sheet displayed.

use ethos_parser_core::{CellTextSource, CellValueType, EngineError};
