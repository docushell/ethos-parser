...
| **v1** | Fabrication rate **0** and an honest table number on the set it owns — **70‰ over twelve tagged PDFs** (v2-S19; 64‰ over four), and the band is what to quote: 0‰..590‰, median 0‰, **nine of twelve at zero**. The **> 0.489** chase is **parked** (decision #10). **Not complete** — #18, which would close it, is written and undecided | The DocuShell replacement gate — tables, full element vocabulary, tagged PDF, forms, vectors |
