...
| **v2** | Anydoc-class formats | DOCX → XLSX → PPTX → ODT → ODS → **RTF/EPUB/CSV and ODP (S7)** · shared IR + one serializer · embedded assets | A DOCX quote and an XLSX cell both ground; **no synthesised pages** |
...
| What is v2 (office formats)? | `14-V2-SCOPE.md` / `15-V2-MILESTONES.md` — **S0–S6 done at 0.25.0; S7 (the rest) not started** |
