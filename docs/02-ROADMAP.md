...
| **v2** | Anydoc-class formats | DOCX → XLSX → PPTX → ODT → ODS → ODP → **RTF/EPUB/CSV (S8)** · shared IR + one serializer · embedded assets | A DOCX quote and an XLSX cell both ground; **no synthesised pages** |
...
| What is v2 (office formats)? | `14-V2-SCOPE.md` / `15-V2-MILESTONES.md` — **S0–S7 done at 0.26.0; S8 (the rest) not started** |
