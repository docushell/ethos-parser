...
| What is v2 (office formats)? | `14-V2-SCOPE.md` / `15-V2-MILESTONES.md` — **S0–S10 done at 0.29.0; S10 is CSV as an argued refusal, not a reader. v2's format row is closed; v2 is not complete** |
