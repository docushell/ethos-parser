...
| `engine-office` | `engine-core` | Any PDF concept, any grounding concept. It reads OOXML packages — documents (v2-S2), workbooks (v2-S3) and presentations (v2-S4) — and emits the shared representation |
