...
score exactly 0‰** — the detector emits no table at all on them. Two documents supply all 849 of the
averaged points, and removing one drops the macro to 23‰. So neither 64‰ nor 70‰ was ever a
