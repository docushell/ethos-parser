...
**Status:** **v1.2 is complete at 0.19.0; v2 reads five formats at 0.25.0.** v1.1 is complete. v1 is
...
**What 0.25.0 can and cannot do, on one page:** [`CAPABILITY.md`](CAPABILITY.md).
...
| [`CAPABILITY.md`](CAPABILITY.md) | What **0.25.0** can and cannot do, as two tables | When someone asks what this engine actually does today |
