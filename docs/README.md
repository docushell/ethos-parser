...
**Status:** **v1.2 is complete at 0.19.0; v2 reads eight formats at 0.28.0.** v1.1 is complete. v1 is
...
**What 0.28.0 can and cannot do, on one page:** [`CAPABILITY.md`](CAPABILITY.md).
...
| [`15-V2-MILESTONES.md`](15-V2-MILESTONES.md) | **v2-S0–S10**, with S0–S9 done and **S10 (CSV) not started** | Every v2 PR. This is the v2 code-review map |
...
| [`CAPABILITY.md`](CAPABILITY.md) | What **0.28.0** can and cannot do, as two tables | When someone asks what this engine actually does today |
