...
**Status:** **v1.2 is complete at 0.19.0; v2 reads eight formats at 0.33.0, and v2's format row
...
**What 0.33.0 can and cannot do, on one page:** [`CAPABILITY.md`](CAPABILITY.md).
...
| [`CAPABILITY.md`](CAPABILITY.md) | What **0.33.0** can and cannot do, as two tables | When someone asks what this engine actually does today |
